...
LG.G.HeaderStream.prototype.getMaxPhotos = function() {
  return Math.floor(this.jdom.width() / this.slideWidth);
};
LG.G.HeaderStream.prototype.getNumPhotos = function() {
  return this.jdom.children().length;
};
LG.G.HeaderStream.prototype.isOverFull = function() {
  return this.getNumPhotos() > this.getMaxPhotos();
};
LG.G.HeaderStream.prototype.isFull = function() {
  return this.getNumPhotos() == this.getMaxPhotos();
};
...
$(document).ready(function() {
  ...
  while (headerStream.add(photos[0])) { photos.push(photos.shift()); }
