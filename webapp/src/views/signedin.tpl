...
<td class="left pane">
  <ol class="detailed stream">
    <?php echo $this->element('detailed_stream', array('photo'=>array('Photo'=>array('id'=>'4b12e638-f028-48b9-af33-0a572641192c'))))?>
    <?php echo $this->element('detailed_stream', array('photo'=>array('Photo'=>array('id'=>'4b121c60-8f54-4d69-b4be-69e62641192c'))))?>
